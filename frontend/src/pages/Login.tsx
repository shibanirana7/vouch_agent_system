    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex w-2/5 bg-blush-500 flex-col justify-between p-14 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <p className="text-4xl font-light text-white leading-tight mb-6">
            Welcome back.
            <br />
            <span className="font-bold">Your agent missed you.</span>
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="text-sm text-gray-500 mb-10">Welcome back to your trust network.</p>
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            ...
            <Link to="/signup" className="text-blush-500 font-semibold hover:text-blush-600 transition-colors">
              Join Vouch
            </Link>
          </p>
        </div>
